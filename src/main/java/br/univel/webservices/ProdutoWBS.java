...
public class ProdutoWBS {
	...
	public String atualizar(@WebParam(name = "IdProduto") Long idProd, @WebParam(name = "Cod_barra") String cod_barra,
			@WebParam(name = "Descricao") String desc, @WebParam(name = "Preco") BigDecimal preco) {
